...
## Как работаем с чекпоинтами

Шаги ниже описаны на нейтральном примере items. Ваша группа делает ровно
то же самое, но со своей сущностью из scenarios/ - у группы N сценарий N.
Механика одинаковая, предметка своя.
